# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in wx.hemna.com.
...
# Enable debubar constantly updating the page
base_config.update_blueprint({
    'debugbar.inventing': True,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "1c96c996-4161-413a-b842-6bf846ea35a9",
